...
function About() {
  ...
  const playGame = e => {
    e.preventDefault()
    //Get user Guess and random number then compare the two, if the guess matches the random number alert "You win!", if it doesnt alert "you lose"
   
    //Set the state to update the picture or the dice that has been rolled
  
  }

  const handleInputChange = e => {
    e.preventDefault()
    // Get users input and set the state to the user input

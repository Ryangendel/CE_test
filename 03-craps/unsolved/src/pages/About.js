...
function About() {
  ...
  //ENTER CODE HERE TO get roll one and roll two based on when one of the states are changed
  ...
  const playGame = e => {
    ...
    //2.Set the state of which hook needs to be set here
  ...
  const handleInputChange = e => {
   ...
   //Set final user data state
  }

  const resetValues = () => {
   //Reset all values in the data state
  }
